# 🛒 Trendify - MERN E-Commerce Platform

**Developed by Flitz Interactive**

Welcome to **Trendify**! This is a feature-rich e-commerce platform built by Flitz Interactive using the powerful MERN stack, complete with an intuitive user-facing store and an all-encompassing admin dashboard.
...
ADMIN_EMAIL = "admin@flitzinteractive.com" #For testing only
